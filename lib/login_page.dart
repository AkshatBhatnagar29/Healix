...
import 'package:healix/doctor_dashboard.dart'; // Correctly imports your doctor dashboard
  ...
  void _signIn() {
    if (idController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter your ID to sign in.'),
    ...
    switch (selectedRole) {
      case 'Student (Patient)':
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => StudentHomepage(studentId: idController.text)),
        );
        break;
      case 'Doctor':
      // This now navigates to your actual DoctorDashboardScreen
        Navigator.push(
          context,
      ...
      case 'Staff':
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => StaffHomepage(staffId: idController.text)),
        );
        break;
    }
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Secure access to campus healthcare',
                  style: TextStyle(
                    fontSize: 14,
