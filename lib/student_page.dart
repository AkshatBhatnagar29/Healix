...
// // Imports for WebRTC
// import 'package:flutter_webrtc/flutter_webrtc.dart';
// import 'package:healix/webrtc_circuit.dart'; // <-- 1. FIXED: Renamed from webrtc_circuit.dart
// import 'package:healix/call_screen.dart'; // <-- 2. FIXED: Renamed from call_screen.dart
//
// class StudentHomepage extends StatefulWidget {
//   final String studentId;
//   const StudentHomepage({super.key, required this.studentId});
...
//     await _fetchProfile(); // Fetch profile data
//
//     // --- 3. THIS IS THE RENDER DEPLOYMENT FIX ---
//     // Get the token from auth service
//     final token = await _authService.getAccessToken();
//     if (token == null) {
//       print("Student Page: No token found, logging out.");
//       _handleLogout();
//       return;
//     }
//
//     // Connect to WebRTC Signaling Server (passing the token)
//     _webRTCService = WebRTCService(
//       currentUserId: widget.studentId,
//       localRenderer: _localRenderer,
//       remoteRenderer: _remoteRenderer,
...
//
//   Widget _buildWelcomeCard() {
//     String name = _profileData?['name'] ?? 'Student';
